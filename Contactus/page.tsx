...
import style from "../Contactus/page.module.css"
...
export default function Contactus() {
    return (    
      ...
      <ul className = {style.links}>
        <Link href="\" className = {style.navc}><li>Home</li></Link>
        <Link href="\Portfolio" className = {style.navc}><li>Portfolio</li></Link>
        <Link href="\About" className = {style.navc}><li>About</li></Link>
        <Link href="\Contactus" className = {style.navc}><li>Contact us</li></Link>
      </ul>
    </div>
    ...
    <div className={style.img}>
        ...
        <h2 className={style.about}>I am Muhammad Owais Imran You can contact me on Discord @owaisimran55555  <br />Email : owaisimran55555@gmail.com</h2>
       </div>
